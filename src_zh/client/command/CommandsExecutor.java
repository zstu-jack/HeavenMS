...
public class CommandsExecutor {
    ...
    private void registerLv6Commands(){
        ...
        addCommand(new String[]{"fame", "加人气"}, 3, FameCommand.class);
        addCommand(new String[]{"givenx", "加点券"}, 3, GiveNxCommand.class);
        // addCommand("givevp", 3, GiveVpCommand.class);
        addCommand(new String[]{"givems", "加金币"}, 3, GiveMesosCommand.class);
        ...
        addCommand(new String[]{"startquest", ".开始任务"}, 3, QuestStartCommand.class);
        addCommand(new String[]{"completequest","完成任务"}, 3, QuestCompleteCommand.class);
        addCommand(new String[]{"resetquest","重置任务"}, 3, QuestResetCommand.class);
        ...
        addCommand(new String[]{"servermessage", "服务器消息"}, 4, ServerMessageCommand.class);
        // addCommand("proitem", 4, ProItemCommand.class);
        // addCommand("seteqstat", 4, SetEqStatCommand.class);
        addCommand(new String[]{"exprate", "经验倍率"}, 4, ExpRateCommand.class);
        addCommand(new String[]{"mesorate","金币倍率"}, 4, MesoRateCommand.class);
        addCommand(new String[]{"droprate","掉落倍率"}, 4, DropRateCommand.class);
        addCommand(new String[]{"bossdroprate","掉落倍率BOSS"}, 4, BossDropRateCommand.class);
        ...
        addCommand(new String[]{"zakum", ".刷扎昆"}, 4, ZakumCommand.class);
        addCommand(new String[]{"horntail",".刷黑龙"}, 4, HorntailCommand.class);
        addCommand(new String[]{"pinkbean", ".刷品克缤"}, 4, PinkbeanCommand.class);
        addCommand(new String[]{"pap", ".刷闹钟"},4, PapCommand.class);
        addCommand(new String[]{"pianus", "刷皮亚努斯"}, 4, PianusCommand.class);
        addCommand(new String[]{"cake","刷巨型蛋糕"}, 4, CakeCommand.class);
        ...
        // addCommand("dcall", 6, DCAllCommand.class);   // disconnect all character
        // addCommand("mapplayers", 6, MapPlayersCommand.class);
        // addCommand("getacc", 6, GetAccCommand.class); // get player account
        ...
        addCommand(new String[]{"goto", ".传送"}, 1, GotoCommand.class);
        addCommand(new String[]{"hide", "隐身"}, 2, HideCommand.class);
        addCommand(new String[]{"unhide","去隐身"}, 2, UnHideCommand.class);
        addCommand(new String[]{"bomb", "丢炸弹"}, 2, BombCommand.class);
